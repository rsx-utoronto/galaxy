...
float pseudoSpeed1 = -1; //forward/backward, joystick element 1
float pseudoSpeed2 = -0.8; //right/left; joystick element 0
float pseudoSpeed3 = -0.5; //rotate right/left about centre axis; joystick element 3
